...
export const PRODUCTS: Product[] = [
  ...
  {
    id: "artist-2",
    idealFor: ["Weddings", "Anniversary", "Haldi", "Sangeeth"],
    ...
    description:
      "Adorn your hands with exquisite designs using our Premium Bridal Mehendi service, ensuring you look stunning on your special day.",
    specifications: [
      "Expert mehendi artist for intricate designs",
      "Premium natural mehendi cones for rich color",
      "Exclusive design catalog for personalized choices",
      "Both hands and feet coverage for complete elegance",
      "Arabic and Indian designs available for variety",
      "Duration: 3-4 hours for detailed artistry",
      "Touch-up service included for perfection",
      "Natural darkening tips for long-lasting color",
      "Aftercare kit provided for maintenance",
    ],
    available: true,
  },
  {
    ...
    description:
      "Achieve the perfect look for any occasion with our Professional Hair Styling service, tailored to your unique style.",
    specifications: [
      "Expert hair stylist for personalized service",
      "Premium styling products for lasting results",
      "Heat protection treatment for hair health",
      "Hair accessories included for added flair",
      "Multiple style options to choose from",
      "Pre-event consultation for tailored looks",
      "Touch-up kit provided for all-day confidence",
      "Style duration: 6-8 hours for stunning results",
      "Extension services available for added volume",
    ],
    available: true,
  },
